...
/// 9 Koordinaten (0–8), identisch zur ursprünglichen Logik.
#[derive(
...
impl Coord {
    ...
    /* ------------------------------
       Konstruktoren (gleich wie vorher)
       ------------------------------ */
