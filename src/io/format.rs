...
/// Provides helper methods for formatting [Board]s
pub struct Format {}
...
/// Produces a single line packed string of the [Board]s cells with a configured character 
/// for all unsolved cells and optional space separating rows
...
/// Produces an ASCII grid of the [Board]s cells for emailing showing the solution or candidates for each cell
#[derive(Default)]
